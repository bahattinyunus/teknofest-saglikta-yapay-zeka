...
class UNet(nn.Module):
    ...
    Biyomedikal görüntü segmentasyonu için en popüler 'Baseline' model.
    """
    ...
    def forward(self, x):
        ...
        # Decoder (Skip Connections ile birleştirme)
        x = self.up1(x5)
        # Boyut uyuşmazlığı varsa padleme gerekebilir (burada basit tutuldu)
...
if __name__ == "__main__":
    ...
    # 1 Kanallı giriş (Gri tonlamalı MR), 2 Sınıflı çıkış (Arkaplan, Tümör)
